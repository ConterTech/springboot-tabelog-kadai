...
INSERT IGNORE INTO user (user_id, name, phone_number, post_code, address, email, age, gender, password, role_id, enabled, paid_flag, delete_flag) VALUES (3, '侍　次郎', '080-3333-5555', '111-1111', '宮城県太田市xxx', 'jiro.samurai@example.com', 27, '男性', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 1, true, 0, 0);
INSERT IGNORE INTO user (user_id, name, phone_number, post_code, address, email, age, gender, password, role_id, enabled, paid_flag, delete_flag) VALUES (4, '侍　幸巳', '080-3333-5555', '111-1111', '宮城県太田市xxx', 'sachimi.samurai@example.com', 27, '男性', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 1, true, 1, 0);
INSERT IGNORE INTO user (user_id, name, phone_number, post_code, address, email, age, gender, password, role_id, enabled, paid_flag, delete_flag) VALUES (5, '侍　みやび', '080-3333-5555', '111-1111', '宮城県太田市xxx', 'miyabi.samurai@example.com', 27, '男性', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 1, true, 1, 0);
INSERT IGNORE INTO user (user_id, name, phone_number, post_code, address, email, age, gender, password, role_id, enabled, paid_flag, delete_flag) VALUES (6, '侍　正康', '080-3333-5555', '111-1111', '宮城県太田市xxx', 'masayasu.samurai@example.com', 27, '男性', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 1, true, 1, 0);
INSERT IGNORE INTO user (user_id, name, phone_number, post_code, address, email, age, gender, password, role_id, enabled, paid_flag, delete_flag) VALUES (7, '侍　由美子', '080-3333-5555', '111-1111', '宮城県太田市xxx', 'yumiko.samurai@example.com', 27, '女性', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 1, true, 1, 0);
INSERT IGNORE INTO user (user_id, name, phone_number, post_code, address, email, age, gender, password, role_id, enabled, paid_flag, delete_flag) VALUES (8, '侍　真由美', '080-3333-5555', '111-1111', '宮城県太田市xxx', 'mayumi.samurai@example.com', 27, '女性', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 1, true, 1, 0);
INSERT IGNORE INTO user (user_id, name, phone_number, post_code, address, email, age, gender, password, role_id, enabled, paid_flag, delete_flag) VALUES (9, '侍　康子', '080-3333-5555', '111-1111', '宮城県太田市xxx', 'yasuko.samurai@example.com', 27, '男性', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 1, true, 1, 0);
INSERT IGNORE INTO user (user_id, name, phone_number, post_code, address, email, age, gender, password, role_id, enabled, paid_flag, delete_flag) VALUES (10, '侍　昭美', '080-3333-5555', '111-1111', '宮城県太田市xxx', 'yoshimi.samurai@example.com', 27, '男性', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 1, true, 1, 0);
INSERT IGNORE INTO user (user_id, name, phone_number, post_code, address, email, age, gender, password, role_id, enabled, paid_flag, delete_flag) VALUES (11, '侍　信平', '080-3333-5555', '111-1111', '宮城県太田市xxx', 'nobuhira.samurai@example.com', 27, '男性', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', 1, true, 1, 0);
...
-- reviewテーブル
INSERT IGNORE INTO review (store_id, user_id, review_star, review_text, delete_flag) VALUES (1, 3, 4, '美味しかった。', 0);
INSERT IGNORE INTO review (store_id, user_id, review_star, review_text, delete_flag) VALUES (1, 4, 3, '美味しかった。', 0);
INSERT IGNORE INTO review (store_id, user_id, review_star, review_text, delete_flag) VALUES (1, 5, 4, 'また行きます。', 0);
INSERT IGNORE INTO review (store_id, user_id, review_star, review_text, delete_flag) VALUES (1, 6, 5, '満足。', 0);
INSERT IGNORE INTO review (store_id, user_id, review_star, review_text, delete_flag) VALUES (1, 7, 1, '価格が高かった。', 0);
INSERT IGNORE INTO review (store_id, user_id, review_star, review_text, delete_flag) VALUES (1, 8, 2, 'サービスと価格があっていない。', 0);
INSERT IGNORE INTO review (store_id, user_id, review_star, review_text, delete_flag) VALUES (1, 9, 4, '美味しかった。', 0);
